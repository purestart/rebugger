...
export default {
  data () {
    return {
      model:{},
       formItems1: [
        { label: '项目名称', prop: 'name', props: { readonly: true }, verify: {} },
        { label: '项目编码', prop: 'code' },
        { label: '项目类型', type: 'select', options:"projectType", prop: 'type', formatter: (row, column, cellValue) => this.$c.projectTypeK[cellValue]},
