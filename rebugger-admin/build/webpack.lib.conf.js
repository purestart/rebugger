...
let buildConfig = buildConfigBuilder.getConfig('frontLogger')
...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    publicPath: '/static/module/frontLogger/',
    filename: 'frontLogger.umd.min.js',
    chunkFilename: 'frontLogger.[name].[chunkhash:8].js',
    library: 'frontLogger',
    libraryTarget: 'umd'
  },
  plugins: [
