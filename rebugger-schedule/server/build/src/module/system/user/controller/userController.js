            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.info(id)];
                    case 1:
                        ret = _a.sent();
                        if (ret) {
                            ctx.response.body = {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ids.forEach(function (id, idx) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, userService.delete(id)];
                                            case 1:
                                                ret_1 = _a.sent();
                                                if (idx == ids.length - 1) {
                                                    resolve();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.create(obj)];
                    case 1:
                        ret = _a.sent();
                        if (ret) {
                            ctx.response.body = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.list(pageSize, pageNum, searchParams)];
                    case 1:
                        ret = _a.sent();
                        if (ret) {
                            ctx.response.body = {
        ...
        function: function (ctx) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        obj = ctx.request.body;
                        return [4 /*yield*/, userService.update(obj)];
                    case 1:
                        ret = _a.sent();
                        if (ret) {
                            ctx.response.body = {
