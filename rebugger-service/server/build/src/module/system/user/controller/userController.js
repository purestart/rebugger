...
var UserController = /** @class */ (function (_super) {
    ...
    function UserController(entityService, prefix, option) {
     ...
     * 自定义扩展路由
     */
    UserController.prototype.getCustomRouter = function () {
        var _this = this;
        return [
            // 自定义扩展
            {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.entityService.updatePassword(obj)];
                            case 1:
                                ret = _a.sent();
                                if (ret) {
                                    ctx.response.body = {
...
var userController = new UserController(userService_1.default, "/api/user", {
    infoCacheable: false,
    findCacheable: false
});
var userRouter = userController
    .getBaseRouter()
