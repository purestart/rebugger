...
var projectSchema_1 = __importDefault(require("../schema/projectSchema"));
var ipAuthService_1 = __importDefault(require("../../ipAuth/service/ipAuthService"));
var ProjectDao = projectSchema_1.default(mysql_1.default, sequelize_1.default);
// 重新生成表
// ProjectDao.sync({ alter: true, force: true });
var ProjectService = /** @class */ (function (_super) {
    __extends(ProjectService, _super);
    function ProjectService() {
        return _super.call(this, ProjectDao) || this;
    }
    /**
     * 保存 新增 修改
     * 重写
     */
    ProjectService.prototype.create = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            var ret, domains;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.create.call(this, model)];
                    case 1:
                        ret = _a.sent();
                        if (model.domain && model.domain.length > 0) {
                            domains = model.domain.split(",");
                            ipAuthService_1.default.createOrUpdateDomain(model.domain);
                        }
                        return [2 /*return*/, ret];
                }
            });
     ...
     * update
     */
    ProjectService.prototype.update = function (model, ignoreFields) {
        if (ignoreFields === void 0) { ignoreFields = []; }
        return __awaiter(this, void 0, void 0, function () {
            var defaultIgnore, o, oldDomain, key;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (model.domain && model.domain.length > 0) {
                            ipAuthService_1.default.createOrUpdateDomain(model.domain, oldDomain);
                        }
